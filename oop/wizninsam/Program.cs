...
namespace wizninsam
{
    ...
    class Program
    {
        ...
        {
            Human shirogane = new Human("Shirogane Miyuki");
            Ninja kei = new Ninja("Shirogane Kei");
            Wizard chika = new Wizard("Fujiwara Chika");
            Samurai kaguya = new Samurai("Shinomiya Kaguya");
            kaguya.Attack(shirogane);
            System.Console.WriteLine(shirogane.Health);
            chika.Heal(shirogane);
            chika.Heal(shirogane);
            kei.Steal(shirogane);
            chika.Attack(shirogane);
            System.Console.WriteLine($"How is {shirogane.Name} doing? HP: {shirogane.Health}");
        }
    }
}
